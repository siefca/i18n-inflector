...
module I18n
  ...
  module Inflector
    ...
    # on both unnamed an named patterns.
    # 
    ...
    class Core < NamedAPI
      ...
      def initialize
        ...
        @named    = I18n::Inflector::NamedAPI.new(@idb, @options)
      end
