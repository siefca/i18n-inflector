...
<b>i18n-inflector version <tt>1.0.1</tt></b> (<b><tt>Aropsaid</tt></b>)
...
See {I18n::Backend::Inflector} module documentation for more information.
...
comply with either the terms of the LGPL (see the file {LGPL-LICENSE}[link:file.LGPL-LICENSE.html]),
or Ruby's license (see the file {COPYING}[link:file.COPYING.html]).
