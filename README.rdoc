...
* Allows inline inflection using patterns.
* Allows key-based inflection using inflection keys.
* Allows one to define own inflection kinds.
* Keeps its configuration within one scope of translation data.
* Supports complex patterns to inflect by more than one kind at a time.
* Supports negative matching, aliases, default tokens, token groups and more…
...
From version 2.2.0 Inflector supports complex patterns,
